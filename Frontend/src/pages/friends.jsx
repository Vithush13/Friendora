                ...
                <div className="min-h-screen bg-slate-50">
                    <div className="max-w-6xl mx-auto p-6">
                        ...
                        <div className="inline-flex flex-wrap items-center border border-gray-200 rounded-md p-1 bg-white shadow-sm">
                            {dataArray.map((tab)=>(
                                <button onClick={()=> setCurrentTab(tab.label)} key={tab.label} className={`flex items-center px-3 py-1 text-sm rounded-md transition-colors cursor-pointer ${currentTab === tab.label ?
                                ...
                                <div key={user._id} className="w-full max-w-88 flex gap-5 p-6 bg-white shadow-md rounded-md">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex max-sm:flex-col gap-2 mt-4">
                                            {
                                                <button onClick={()=> navigate(`/profile/${user._id}`)} className="w-full p-2 text-sm rounded bg-gradient-to-r from-indigo-400 to-blue-600 hover:from-indigo-500 hover:to-blue-700 active:scale-95 transition 
