...
export default  function StoryViewer({viewStory, setViewStory}){
    ...
    useEffect(()=>{
        ...
        if(viewStory && viewStory.media_type !== 'video'){
            ...
            //close story after dutaion 10sec
            timer= setTimeout(()=>{
                setViewStory(nulll)
    ...
    return(
        <div className="fixed inset-0 h-screen bg-black bg-opacity-90 z-110 flex items-center justify-center" style={{backgroundColor: viewStory.media_type === 'text' ?
            viewStory.background_color : '#000000'}}>
                ...
                {/*Content Wrapper */}
                <div className="max-w-[90vm] max-h-[90vm] flex items-center justify-center">
                    {renderContent()}
                </div>
            </div>
    )
